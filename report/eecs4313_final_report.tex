...
%   }
    ...
    In the method \code{getSupportedOutputFormats()}, equivalence classes were
        defined based on whether \code{ImageIO.getWriterFormatNames()} returns a
    ...
    Similarly, the image type parameter was tested using common supported types
        as well as the special \code{TYPE\_CUSTOM}, which should be internally
        substituted with \code{TYPE\_INT\_ARGB}.
